...
void bind_mace_kokkos(py::module_& m, const char* class_name) {
    py::class_<MACEKokkos<Precision>>(m, class_name)
        ...
        .def_property_readonly(
            "atomic_numbers",
            [](MACEKokkos<Precision>& self) { return view2vector(self.atomic_numbers); })
        .def_readonly("r_cut", &MACEKokkos<Precision>::r_cut)
        // node energies
        .def_property(
            "node_energies",
            [](MACEKokkos<Precision>& self) { return view2vector(self.node_energies); },
        ...
        .def_property(
            "node_forces",
            [](MACEKokkos<Precision>& self) { return view2vector(self.node_forces); },
        ...
        .def("compute_node_energies_forces",
             [](MACEKokkos<Precision>& self, const int num_nodes, py::array_t<int> node_types,
                py::array_t<int> num_neigh, py::array_t<int> neigh_indices,
                py::array_t<int> neigh_types, py::array_t<double> xyz, py::array_t<double> r) {
                 self.compute_node_energies_forces(
                     num_nodes, create_kokkos_view("node_types", node_types),
                     create_kokkos_view("num_neigh", num_neigh),
                     create_kokkos_view("neigh_indices", neigh_indices),
                     create_kokkos_view("neigh_types", neigh_types), create_kokkos_view("xyz", xyz),
                     create_kokkos_view("r", r));
             })
        // R0
        .def_property(
            "R0", [](MACEKokkos<Precision>& self) { return view2vector(self.R0); },
        ...
        .def("compute_R0",
             [](MACEKokkos<Precision>& self, const int num_nodes, py::array_t<int> node_types,
                py::array_t<int> num_neigh, py::array_t<int> neigh_types, py::array_t<double> r) {
                 self.compute_R0(num_nodes, create_kokkos_view("node_types", node_types),
                                 create_kokkos_view("num_neigh", num_neigh),
        ...
        // R1
        .def_property(
            "R1", [](MACEKokkos<Precision>& self) { return view2vector(self.R1); },
        ...
        .def("compute_R1",
             [](MACEKokkos<Precision>& self, const int num_nodes, py::array_t<int> node_types,
                py::array_t<int> num_neigh, py::array_t<int> neigh_types, py::array_t<double> r) {
                 self.compute_R1(num_nodes, create_kokkos_view("node_types", node_types),
                                 create_kokkos_view("num_neigh", num_neigh),
                                 create_kokkos_view("neigh_types", neigh_types),
                                 create_kokkos_view("r", r));
             })
        // Y
        .def("compute_Y",
             [](MACEKokkos<Precision>& self, py::array_t<double> xyz) {
                 self.compute_Y(create_kokkos_view("xyz", xyz));
             })
        // A0
        .def_property(
            "A0", [](MACEKokkos<Precision>& self) { return view2vector(self.A0); },
        ...
        .def_property(
            "A0_adj", [](MACEKokkos<Precision>& self) { return view2vector(self.A0_adj); },
        ...
        .def("compute_A0",
             [](MACEKokkos<Precision>& self, int num_nodes, py::array_t<int> node_types,
                py::array_t<int> num_neigh, py::array_t<int> neigh_types) {
                 self.compute_A0(num_nodes, create_kokkos_view("node_types", node_types),
                                 create_kokkos_view("num_neigh", num_neigh),
                                 create_kokkos_view("neigh_types", neigh_types));
             })
        .def("reverse_A0",
             [](MACEKokkos<Precision>& self, int num_nodes, py::array_t<int> node_types,
                py::array_t<int> num_neigh, py::array_t<int> neigh_types, py::array_t<double> xyz,
                py::array_t<double> r) {
                 self.reverse_A0(num_nodes, create_kokkos_view("node_types", node_types),
                                 create_kokkos_view("num_neigh", num_neigh),
                                 create_kokkos_view("neigh_types", neigh_types),
                                 create_kokkos_view("xyz", xyz), create_kokkos_view("r", r));
             })
        .def("compute_A0_scaled",
             [](MACEKokkos<Precision>& self, const int num_nodes, py::array_t<int> node_types,
                py::array_t<int> num_neigh, py::array_t<int> neigh_types, py::array_t<double> r) {
                 self.compute_A0_scaled(num_nodes, create_kokkos_view("node_types", node_types),
                                        create_kokkos_view("num_neigh", num_neigh),
                                        create_kokkos_view("neigh_types", neigh_types),
                                        create_kokkos_view("r", r));
             })
        .def("reverse_A0_scaled",
             [](MACEKokkos<Precision>& self, const int num_nodes, py::array_t<int> node_types,
                py::array_t<int> num_neigh, py::array_t<int> neigh_types, py::array_t<double> xyz,
                py::array_t<double> r) {
                 self.reverse_A0_scaled(num_nodes, create_kokkos_view("node_types", node_types),
                                        create_kokkos_view("num_neigh", num_neigh),
                                        create_kokkos_view("neigh_types", neigh_types),
                                        create_kokkos_view("xyz", xyz), create_kokkos_view("r", r));
             })
        // M0
        .def_property(
            "M0", [](MACEKokkos<Precision>& self) { return view2vector(self.M0); },
        ...
        .def_property(
            "M0_adj", [](MACEKokkos<Precision>& self) { return view2vector(self.M0_adj); },
        ...
        .def("compute_M0",
             [](MACEKokkos<Precision>& self, int num_nodes, py::array_t<int> node_types) {
                 self.compute_M0(num_nodes, create_kokkos_view("node_types", node_types));
             })
        .def("reverse_M0",
             [](MACEKokkos<Precision>& self, int num_nodes, py::array_t<int> node_types) {
                 self.reverse_M0(num_nodes, create_kokkos_view("node_types", node_types));
             })
        // H1
        .def_property(
            "H1", [](MACEKokkos<Precision>& self) { return view2vector(self.H1); },
        ...
        .def_property(
            "H1_adj", [](MACEKokkos<Precision>& self) { return view2vector(self.H1_adj); },
        ...
        // Phi1
        .def_property(
            "Phi1", [](MACEKokkos<Precision>& self) { return view2vector(self.Phi1); },
        ...
        .def_property(
            "Phi1_adj", [](MACEKokkos<Precision>& self) { return view2vector(self.dPhi1); },
        ...
        .def("compute_Phi1",
             [](MACEKokkos<Precision>& self, const int num_nodes, py::array_t<int> num_neigh,
                py::array_t<int> neigh_types) {
                 self.compute_Phi1(num_nodes, create_kokkos_view("num_neigh", num_neigh),
                                   create_kokkos_view("neigh_types", neigh_types));
             })
        .def("reverse_Phi1",
             [](MACEKokkos<Precision>& self, const int num_nodes, py::array_t<int> num_neigh,
                py::array_t<int> neigh_indices, py::array_t<double> xyz, py::array_t<double> r,
                bool zero_dxyz, bool zero_H1_adj) {
                 self.reverse_Phi1(num_nodes, create_kokkos_view("num_neigh", num_neigh),
                                   create_kokkos_view("neigh_indices", neigh_indices),
                                   create_kokkos_view("xyz", xyz), create_kokkos_view("r", r),
                                   zero_dxyz, zero_H1_adj);
             })
        // A1
        .def_property(
            "A1", [](MACEKokkos<Precision>& self) { return view2vector(self.A1); },
        ...
        .def_property(
            "A1_adj", [](MACEKokkos<Precision>& self) { return view2vector(self.A1_adj); },
        ...
        .def("compute_A1",
             [](MACEKokkos<Precision>& self, int num_nodes) { self.compute_A1(num_nodes); })
        .def("reverse_A1",
             [](MACEKokkos<Precision>& self, int num_nodes) { self.reverse_A1(num_nodes); })
        .def("compute_A1_scaled",
             [](MACEKokkos<Precision>& self, const int num_nodes, py::array_t<int> node_types,
                py::array_t<int> num_neigh, py::array_t<int> neigh_types, py::array_t<double> r) {
                 self.compute_A1_scaled(num_nodes, create_kokkos_view("node_types", node_types),
                                        create_kokkos_view("num_neigh", num_neigh),
                                        create_kokkos_view("neigh_types", neigh_types),
                                        create_kokkos_view("r", r));
             })
        .def("reverse_A1_scaled",
             [](MACEKokkos<Precision>& self, const int num_nodes, py::array_t<int> node_types,
                py::array_t<int> num_neigh, py::array_t<int> neigh_types, py::array_t<double> xyz,
                py::array_t<double> r) {
                 self.reverse_A1_scaled(num_nodes, create_kokkos_view("node_types", node_types),
                                        create_kokkos_view("num_neigh", num_neigh),
                                        create_kokkos_view("neigh_types", neigh_types),
                                        create_kokkos_view("xyz", xyz), create_kokkos_view("r", r));
             })
        // M1
        .def_property(
            "M1", [](MACEKokkos<Precision>& self) { return view2vector(self.M1); },
        ...
        .def_property(
            "M1_adj", [](MACEKokkos<Precision>& self) { return view2vector(self.M1_adj); },
        ...
        .def("compute_M1",
             [](MACEKokkos<Precision>& self, int num_nodes, py::array_t<int> node_types) {
                 self.compute_M1(num_nodes, create_kokkos_view("node_types", node_types));
             })
        .def("reverse_M1",
             [](MACEKokkos<Precision>& self, int num_nodes, py::array_t<int> node_types) {
                 self.reverse_M1(num_nodes, create_kokkos_view("node_types", node_types));
             })
        // H2
        .def_property(
            "H2", [](MACEKokkos<Precision>& self) { return view2vector(self.H2); },
        ...
        .def_property(
            "H2_adj", [](MACEKokkos<Precision>& self) { return view2vector(self.H2_adj); },
        ...
        .def("compute_H2",
             [](MACEKokkos<Precision>& self, const int num_nodes, py::array_t<int> node_types) {
                 self.compute_H2(num_nodes, create_kokkos_view("node_types", node_types));
             })
        .def("reverse_H2",
             [](MACEKokkos<Precision>& self, const int num_nodes, py::array_t<int> node_types,
                bool zero_H1_adj) {
                 self.reverse_H2(num_nodes, create_kokkos_view("node_types", node_types),
                                 zero_H1_adj);
             })
        // readouts
        .def("compute_readouts", [](MACEKokkos<Precision>& self, const int num_nodes,
                                    py::array_t<int> node_types) {
            return self.compute_readouts(num_nodes, create_kokkos_view("node_types", node_types));
        });
}
