...
void bind_mace_kokkos(py::module_ &m, const char* class_name)
{
    py::class_<MACEKokkos<Precision>>(m, class_name)
        ...
        .def_property("R0",
            ...
            [] (MACEKokkos<Precision>& self, py::array_t<double> R0) {
        ...
        .def_property("R1",
            ...
            [] (MACEKokkos<Precision>& self, py::array_t<double> R1) {
        ...
        .def_property("M0",
            ...
            [] (MACEKokkos<Precision>& self, py::array_t<double> M0) {
        ...
        .def_property("M0_adj",
            ...
            [] (MACEKokkos<Precision>& self, py::array_t<double> M0_adj) {
        ...
        .def_property("H1",
            ...
            [] (MACEKokkos<Precision>& self, py::array_t<double> H1) {
        ...
        .def_property("H1_adj",
            ...
            [] (MACEKokkos<Precision>& self, py::array_t<double> H1_adj) {
        ...
        .def_property("M1",
            ...
            [] (MACEKokkos<Precision>& self, py::array_t<double> M1) {
        ...
        .def_property("M1_adj",
            ...
            [] (MACEKokkos<Precision>& self, py::array_t<double> M1_adj) {
