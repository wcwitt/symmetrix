...
{
    py::class_<MACEKokkos>(m, "MACEKokkos")
        ...
        .def_property("node_energies",
            ...
            [] (MACEKokkos& self, py::array_t<double> node_energies) {
        ...
        .def_property("node_forces",
            ...
            [] (MACEKokkos& self, py::array_t<double> node_forces) {
        ...
        .def_property("R0",
            ...
            [] (MACEKokkos& self, py::array_t<double> R0) {
        ...
        .def_property("R1",
            ...
            [] (MACEKokkos& self, py::array_t<double> R1) {
        ...
        .def_property("A0",
            ...
            [] (MACEKokkos& self, py::array_t<double> A0) {
        ...
        .def_property("A0_adj",
            ...
            [] (MACEKokkos& self, py::array_t<double> A0_adj) {
        ...
        .def_property("M0",
            ...
            [] (MACEKokkos& self, py::array_t<double> M0) {
        ...
        .def_property("M0_adj",
            ...
            [] (MACEKokkos& self, py::array_t<double> M0_adj) {
        ...
        .def_property("H1",
            ...
            [] (MACEKokkos& self, py::array_t<double> H1) {
        ...
        .def_property("H1_adj",
            ...
            [] (MACEKokkos& self, py::array_t<double> H1_adj) {
        ...
        .def("compute_H1", &MACEKokkos::compute_H1)
        .def("reverse_H1", &MACEKokkos::reverse_H1)
        // Phi1
        .def_property("Phi1",
            [] (MACEKokkos& self) {
                return view2vector(self.Phi1);
            },
            [] (MACEKokkos& self, py::array_t<double> Phi1) {
        ...
        .def_property("Phi1_adj",
            ...
            [] (MACEKokkos& self, py::array_t<double> dPhi1) {
        ...
        .def_property("A1",
            ...
            [] (MACEKokkos& self, py::array_t<double> A1) {
        ...
        .def_property("A1_adj",
            ...
            [] (MACEKokkos& self, py::array_t<double> A1_adj) {
        ...
        .def_property("M1",
            ...
            [] (MACEKokkos& self, py::array_t<double> M1) {
        ...
        .def_property("M1_adj",
            ...
            [] (MACEKokkos& self, py::array_t<double> M1_adj) {
        ...
        .def_property("H2",
            ...
            [] (MACEKokkos& self, py::array_t<double> H2) {
        ...
        .def_property("H2_adj",
            ...
            [] (MACEKokkos& self, py::array_t<double> H2_adj) {
