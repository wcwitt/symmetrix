...
def main():
    ...
    output = extract_model_data(args.model_file, args.atomic_numbers, args.head)

    ### ----- WRITE JSON -----

    if args.output_file is None:
        args.output_file = model_name + '-' + '-'.join(str(a) for a in sorted(args.atomic_numbers)) + '.json'
