...
class ZBL {
   public:
    ...
    ZBL(double a_exp, double a_prefactor, std::vector<double> c, std::vector<double> covalent_radii,
        int p);
    ...
    void compute_ZBL(const int num_nodes, std::span<const int> node_types,
