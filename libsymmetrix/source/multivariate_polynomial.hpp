...
class MultivariatePolynomial {
   public:
    MultivariatePolynomial(int num_variables, std::vector<double> coefficients,
    ...
    auto evaluate_batch(const std::vector<double>& x, const int batch_size)
    ...
    auto evaluate_gradient_simple(const std::vector<double>& x)
